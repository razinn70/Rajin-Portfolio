...
async function init(): Promise<void> {
  ...
  if (projectsEl) new ProjectCards(projectsEl).mount()
  if (aboutEl)    new AboutSection(aboutEl).mount()
  if (contactEl)  new ContactSection(contactEl).mount()
