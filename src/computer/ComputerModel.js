...
export class ComputerModel {
    ...
    constructor(scene) {
        ...
        this.screenMesh = new THREE.Mesh(screenGeo, new THREE.MeshBasicMaterial({ color: 0x050a0a }));
        ...
        for (let row = 0; row < 3; row++) {
            for (let col = 0; col < 10; col++) {
                ...
                key.position.set(-0.49 + col * 0.105, -0.305, 0.43 + row * 0.09);
                this.group.add(key);
            }
        }
        // --- Mouse ---
